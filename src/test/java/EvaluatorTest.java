...
public class EvaluatorTest {
  ...
  public static final List<List<Card>> ORDERED_CONFIGURED_HANDS = List.of(HIGH_CARD, HIGH_CARD_ACE, PAIR,PAIR_SIX, TWO_PAIRS, TWO_PAIRS_BETTER, THREE_OF_A_KIND, STRAIGHT, FLUSH, FULL_HOUSE, FOUR_OF_A_KIND, STRAIGHT_FLUSH);
  ...
  private static Stream<Arguments> providePairsOfHands() {
    ...
    //generate games with 2 hands and the second hand always winning due to increasing score of manually ordered list
